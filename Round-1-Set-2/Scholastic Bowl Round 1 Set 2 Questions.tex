...
\begin{enumerate}
    ...
    % Question 10
    \item \textbf{SOCIAL SCIENCE} \\ The Speaker of \textit{this} state's House of Representatives, Mike Madigan, resigned in 2021 after fifty years in office. Despite being a Republican, Adam Kinziger, a congressman from \textit{this} state, voted to impeach Donald Trump. Brandon Johnson is the fourteenth consecutive Democrat to hold office as a mayor in \textit{this} state, which Donald Trump said was more dangerous than Afghanistan. For 10 points, name \textit{this} state which JB Pritzker governs from Springfield. \backtrack
