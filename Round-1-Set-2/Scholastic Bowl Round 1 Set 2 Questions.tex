...
\begin{enumerate}
    ...
    \item \textbf{MISCELLANEOUS} \\ Name these saws you might find at a woodshop.
    \begin{enumerate}[label=\Alph*]
        ...
        \item \textit{This} saw can only make crosscuts but can do so at an angle. The sliding, compound version of \textit{this} saw allows larger boards to be cut and can also make bevel cuts. \\ ANSWER: \underline{Miter} saw
    \end{enumerate}
