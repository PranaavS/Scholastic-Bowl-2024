...
\begin{enumerate}
    ...
    \begin{enumerate}[label=\Alph*]
        ...
        \item \textit{This} quantity is measured in kilogram-meters squared per second squared. \\ ANSWER: \underline{energy} [also accept \underline{work} or \underline{heat} (but \textbf{not} \textit{temperature}); do \textbf{not} accept or prompt on \textit{joule}]
    \end{enumerate}
\end{enumerate}
